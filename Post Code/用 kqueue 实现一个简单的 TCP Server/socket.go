...
func (socket *Socket) String() string {
	return fmt.Sprintf("%v", socket.FileDescriptor)
}
...
func Listen(ip string, port int) (*Socket, error) {
	...
	// syscall.SOCK_STREAM 字节流、可靠的双向连接
	// 0 TCP
...
type EventLoop struct {
	KqueueFileDescriptor syscall.Handle
	SocketFileDescriptor syscall.Handle
}
...
// https://zhuanlan.zhihu.com/p/436550382