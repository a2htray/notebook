...
func main() {
	http.Handle("/api/city", filterContentType(setServerTimeCookie(http.HandlerFunc(postSaveCity))))
	http.Handle("/api/cities", setServerTimeCookie(http.HandlerFunc(getListCities)))
